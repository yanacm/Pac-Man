...
public class Nivel {
	...
	public static final int FT1 = 10;//fruta 1
	public static final int FT2 = 11;//fruta 2
	...
	public static int[][] cenario = {
		...
		{ BL, CN, BL, BL, BL, BL, CN, BL, BL, CN, BL, BL, BL, BL, BL, BL, BL, BL, CN, BL, BL, CN, BL, BL, BL, BL, CN, BL },
		{ BL, CN, CN, CN, CN, FT1, CN, BL, BL, CN, CN, CN, CN, BL, BL, CN, CN, CN, CN, BL, BL, CN, CN, CN, CN, CN, CN, BL },
		...
		{ BL, CN, BL, BL, BL, BL, CN, BL, BL, BL, BL, BL, CN, BL, BL, CN, BL, BL, BL, BL, BL, CN, BL, BL, BL, BL, CN, BL },
		{ BL, CN, BL, BL, BL, BL, CN, BL, BL, BL, BL, BL, CN, BL, BL, CN, BL, BL, BL, BL, BL, CN, BL, BL, BL, BL, CN, BL },
		{ BL, SC, CN, CN, BL, BL, CN, CN, CN, CN, CN, CN, CN, CN, CN, CN, CN, CN, CN, CN, CN, FT2, BL, BL, CN, CN, SC, BL },
